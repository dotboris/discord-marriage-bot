...
module.exports.propose = async function ({questions: qdb, db}, message, person) {
  ...
  questions.create(qdb, authorId, personId, 60 * 1000, {
    async onAnswer (answer) {
      // TODO: if this crashes, no one actually receives this error
      await relationships.add(db, authorId, personId, 'engaged')
